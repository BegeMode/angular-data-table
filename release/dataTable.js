      ...
      value: function onTreeToggled(row, cell) {
        ...
        if (row._lazyChildren && !row._loaded_) {
          ...
          this.onTreeLoad(row, cell).then(function (data) {
            ...
            self._hackToAvoidUnwantedScroll_ = true;
